...
export class DiffMatchPatch {
  ...
  public patchMake(
    ...
    if (
      ...
      text1 = /** @type {string} */ a;
      const diffsResult = this.diffMain(
        text1,
        /** @type {string} */ optB,
        true
      );
  ...
  public patchFromText(
    ...
    while (textPointer < text.length) {
      ...
      if (!m) {
        return Err(
          InvalidArgumentError('Invalid patch string: ' + text[textPointer]!)
        );
      }
  ...
  private diffCompute(
    ...
    if (hmOption.some) {
      ...
      return Ok(
        diffsA
          .safeUnwrap()
          .concat([[DiffOp.EQUAL, midCommon]], diffsB.safeUnwrap())
      );
    }
